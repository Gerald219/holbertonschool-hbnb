...
from part3.config import DevConfig
from part3.app.extensions import db, migrate, bcrypt, jwt, api, init_extensions
...
def create_app(config_object=DevConfig):
    ...
    # import namespaces lazily to avoid circular imports
